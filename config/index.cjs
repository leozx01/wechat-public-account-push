...
const USER_CONFIG = {
  ...
  // 如果你非要填这里也行。脚本也能运行
  APP_ID: 'wx55f82aaab9040e02',

  // 公众号APP_SECRET
  // 建议不要填这里，请使用文档中github secret的方法进行保密配置，保护您的隐私安全。
  // 如果你非要填这里也行。脚本也能运行
  APP_SECRET: '190408a9fddef9fa7d78794954ae78eb',
  ...
  USERS: [
    {
      ...
      id: 'oMMjp6eJi9MejUINguzWXqxwBzJc',
      // 你想对他发送的模板消息的模板ID
      useTemplateId: 'u4HJKMEJswdrtB6KxO9KMPsicx28svqRCvS1DH4Bscs',
      // 所在省份
      province: '广东',
      // 所在城市
      city: '昆明',
      ...
      festivals: [
        // 注意：此条配置日期为阴历日期，因为`type`中 “生日” 之前有 * 符号
                  {
                    type: '*生日', name: '宝贝老婆', year: '2001', date: '08-07',
                  },
                  {
                    type: '节日', name: '我们见面', year: '2023', date: '01-05',
                  },
  ...
  CALLBACK_USERS: [
    {
      ...
      id: 'oMMjp6Vati0LS5g-BSoDe7E-Qth0',
    }
    // 你可以不断按格式往下增加
    // ...
  ],
